...
//coins
function Coin(pos) {
	this.basePos = this.pos = pos.plus(new Vector(.5, -.2));
...
var verticalSpeed = -6.9, verticalDist = -.69
...
var enemySpeed =4, enemyDist = 1.2
